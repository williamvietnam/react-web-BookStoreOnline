...
export const styles = theme => ({
  ...
  outlined: {
    ...
    '&$disabled': {
      ...
      border: `1px solid ${theme.palette.type === 'light' ? 'rgba(0, 0, 0, 0.13)' : 'rgba(255, 255, 255, 0.13)'}`,
      pointerEvents: 'none'
    },
    '&$selected': {
...
const PaginationItem = React.forwardRef(function PaginationItem(props, ref) {
  const {
    ...
    variant
        ...
        other = _objectWithoutPropertiesLoose(props, ["classes", "className", "color", "component", "disabled", "getAriaLabel", "page", "onClick", "selected", "shape", "size", "type", "variant"]);

  return type === 'start-ellipsis' || type === 'end-ellipsis' ? React.createElement("div", {
    ref: ref,
    className: clsx(classes.ellipsis, disabled && classes.disabled, size !== 'medium' && classes[`size${capitalize(size)}`])
    ...
    className: clsx(classes.root, classes[variant], classes[shape], className, color !== 'standard' && classes[`${variant}${capitalize(color)}`], disabled && classes.disabled, selected && classes.selected, size !== 'medium' && classes[`size${capitalize(size)}`])
  }, other), type === 'page' && page, type === 'previous' && React.createElement(NavigateBeforeIcon, {
    className: clsx(classes.icon, size !== 'medium' && classes[`size${capitalize(size)}`])
